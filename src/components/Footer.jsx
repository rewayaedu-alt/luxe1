    ...
    <footer className="mt-12 border-t border-border bg-[#0b0d12]">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-8 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-md text-sm text-zinc-400">A gallery-first browse directory for categories, tags, stars, creators, and channels.</p>
        </div>
        <div className="flex flex-wrap gap-4">
          <Link to="/" className="hover:text-foreground">Popular</Link>
          <Link to="/categories" className="hover:text-foreground">Categories</Link>
          <Link to="/stars" className="hover:text-foreground">Stars</Link>
          ...
          <Link to="/upload" className="hover:text-foreground">Admin</Link>
        </div>
        <p>(c) 2026 Luxious</p>
      </div>
    </footer>
